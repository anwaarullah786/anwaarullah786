...
I am a **Data Science fresher from India** focused on solving real-world business problems using **Python, SQL, Excel, dashboards, machine learning, and AI-powered analytics**.

I enjoy converting raw datasets into **clear insights, KPI dashboards, business recommendations, and decision-support solutions**.

* 🔭 Currently working on **Data Analytics, Supply Chain Analytics, and AI dashboard projects**
* 🌱 Currently learning **Machine Learning, Generative AI, Power BI, Tableau, and Advanced Analytics**
* 👯 Open to collaborate on **Data Science, Data Analytics, ML, and Dashboard Development projects**
* 💬 Ask me about **Python, EDA, Excel, SQL, Streamlit, Tableau, and Business Insights**
* 📫 Reach me at **[anwaar78625@gmail.com](mailto:anwaar78625@gmail.com)**
* ⚡ Belief: **Data is not just numbers — it is the future of decision-making**

</td>
<td width="42%" align="center">

<img src="https://media.giphy.com/media/qgQUggAC3Pfv687qPC/giphy.gif" width="360" alt="Data Science Coding Animation" />
...
class MdAnwaarullahKhan:
    ...
    tools = [
        ...
        "Streamlit", "Tableau", "Power BI", "Jupyter"
    ]

    mission = "Transform data into business value"
...
A complete analytics project focused on identifying shipping delays, route inefficiencies, regional bottlenecks, and lead-time patterns.

**Highlights**

* Route efficiency analysis
* State and region-wise delay insights
* Ship mode comparison
* Interactive dashboard
* Logistics improvement recommendations
...
A business analytics project designed to evaluate revenue, profitability, customer value, product performance, discount impact, and regional trends.
...
**Tech Used**
`Python` `Pandas` `Plotly` `Streamlit` `Business Analytics`
...
A Python-based project focused on analyzing housing data, cleaning raw data, understanding price patterns, and identifying factors affecting house prices.
...
* Regression-based understanding
...
## 🚗 Recession Impact on Automobile Sales

**Data Visualization | Python | Business Insights**

A visualization-focused project analyzing how recession periods affect automobile sales trends and business performance.
...
* Data-driven conclusion building

**Tech Used**
`Python` `Matplotlib` `Seaborn` `Folium` `Data Visualization`
...
<img width="48%" src="https://github-readme-stats.vercel.app/api?username=anwaarullah786&show_icons=true&theme=tokyonight&hide_border=true&rank_icon=github" />
<img width="48%" src="https://github-readme-stats.vercel.app/api/top-langs/?username=anwaarullah786&layout=compact&theme=tokyonight&hide_border=true" />

<br><br>

<img width="70%" src="https://github-readme-streak-stats.herokuapp.com/?user=anwaarullah786&theme=tokyonight&hide_border=true" />

<br><br>

<img width="95%" src="https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=anwaarullah786&theme=tokyonight" />
...
| Area             | Focus                                                 |
| ---------------- | ----------------------------------------------------- |
| 🎯 Career Goal   | Data Analyst / Data Science Fresher Role              |
| 📊 Core Strength | EDA, Dashboards, KPI Analysis, Business Insights      |
| 🤖 AI Interest   | Machine Learning, Generative AI, Predictive Analytics |
| 🛠️ Tools        | Python, SQL, Excel, Tableau, Power BI, Streamlit      |
| 🚀 Mission       | Convert data into business value                      |
